        ...
        <div className="page contact" id="take-contact">
            ...
            >
                ...
                <Grid2 className="contact-font" xs={12} sm={10} md={8} lg={6}>
                    {/* {availableForWork()} */}
                    <p className="margin-links">
                        <MailIcon sx={{fontSize: "1.2rem", margin: "0 1rem -.2rem"}}/>
                        {t.contact.writeMe}
                        <span>
              <a href={"mailto:" + t.contact.mail + t.contact.domainName} className="mail-and-phone margin-button">
              {t.contact.mail}
                  {t.contact.domainName}
                    ...
                    <p className="margin-links">
                        ...
                        {t.contact.callMe}
                        <span>
              <a href={"tel:" + t.contact.phone} className="mail-and-phone margin-button">
                {t.contact.phone}
              </a>
            </span>
                        <CopyAllIcon sx={{fontSize: "1.2rem", margin: "0 0.5rem -.2rem", cursor: "pointer"}}
                    ...
                    <p className="margin-links">
                        ...
                        <span>
              <button onClick={dlDocument} className="mail-and-phone"
                      style={{margin: "-1vh 0 0 2vh", padding: "1.2%", border: "none"}}
              >
              {t.contact.resume}
              </button>
            </span>
